...
| [review-panel-hook](plugins/review-panel-hook) | PreToolUse | Dispatches five read-only reviewer subagents (DRY, explicitness, bloat, SOLID, comments) over every commit |
