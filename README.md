...
| [pr-flow](plugins/pr-flow) | Skill + PostToolUse | Nudges after every commit/push toward a pushed branch and an open PR, and writes the PR description (measured failure, mermaid mechanism, checks, risk) |
